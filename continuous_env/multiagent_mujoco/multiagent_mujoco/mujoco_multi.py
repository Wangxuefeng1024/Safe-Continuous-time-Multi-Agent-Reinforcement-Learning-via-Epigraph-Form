...
from .multiagentenv import MultiAgentEnv, continued_MultiAgentEnv
...
class MujocoMulti(MultiAgentEnv):
    ...
    def step_con(self, actions, dts):
        ...
        obs_n, reward_n, done_n, info_n = self.wrapped_env.step_con(env_actions, dts)
        self.steps += 1
...
class continued_MujocoMulti(continued_MultiAgentEnv):
