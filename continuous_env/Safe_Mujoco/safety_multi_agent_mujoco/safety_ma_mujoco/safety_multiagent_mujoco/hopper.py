...
class HopperEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    ...
    def step_con(self, a,dt):
        ...
        distance = posafter - (mocapx - 1)
        if distance >= 0:
            continuous_cost = 20 * distance
        else:
            continuous_cost = 0.5*distance
        ...
        ob = self._get_obs()
        return ob, reward, done, dict(cost=cost, cost_obj = obj_cost, continuous_cost=continuous_cost)
